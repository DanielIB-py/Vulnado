        ...
        steps {
                ...
                script {
                    withCredentials([string(credentialsId: 'poc.polarissynopsys.com', variable: 'BRIDGE_POLARIS_ACCESSTOKEN')]) {
                        ...
                        sh('curl -fLsS -o bridge.zip $BRIDGECLI_LINUX64 && unzip $RUNNER_TEMP bridge.zip && rm -f bridge.zip $WORKSPACE_TMP/synopsys-bridge --verbose && polaris polaris.assessment.types=SAST,SCA')
